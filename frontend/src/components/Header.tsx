...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      <header className="border-b border-slate-800 bg-[#0c121e]/90 backdrop-blur-md sticky top-0 z-40">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 font-medium">Human Review Dashboard & Control Center</p>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge !== undefined && (
                      <span className={`text-xs px-1.5 py-0.2 rounded-full border font-mono font-semibold ${item.badgeColor}`}>
                        {item.badge}
                      </span>
                    )}
                  </button>
            ...
            <div className="flex items-center space-x-3">
              {needsInputCount > 0 && (
                <div className="flex items-center space-x-1.5 px-2.5 py-1 rounded-full bg-rose-500/15 border border-rose-500/30 text-rose-300 text-xs font-medium animate-pulse">
                  <AlertTriangle className="w-3.5 h-3.5" />
                  <span>{needsInputCount} Needs Input</span>
                </div>
              )}
